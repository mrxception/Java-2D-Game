...
public class MouseInputs implements MouseListener, MouseMotionListener {
	...
	public void mouseMoved(MouseEvent e) {
		switch (Gamestate.state) {
			...
			case STORY -> gamePanel.getGame().getStoryLine().mouseMoved(e);
	...
	public void mouseClicked(MouseEvent e) {
		switch (Gamestate.state) {
			...
			case STORY -> gamePanel.getGame().getStoryLine().mouseClicked(e);
		}
	}
	...
	public void mousePressed(MouseEvent e) {
		switch (Gamestate.state) {
			...
			case STORY -> gamePanel.getGame().getStoryLine().mousePressed(e);
	...
	public void mouseReleased(MouseEvent e) {
		switch (Gamestate.state) {
			...
			case STORY -> gamePanel.getGame().getStoryLine().mouseReleased(e);
