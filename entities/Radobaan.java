...
public class Radobaan extends Enemy {
	...
	public Radobaan(float x, float y) {
		super(x, y, RADOBAAN_WIDTH, RADOBAAN_HEIGHT, RADOBAAN);
		initHitbox(17, 21);
	}
	...
	private void checkDmgToPlayer(Player player) {
		if (hitbox.intersects(player.getHitbox()))
			if (tickSinceLastDmgToPlayer >= 60) {
				...
				player.changeHealth(-GetEnemyDmg(getEnemyType()), this);
			} else
